...
namespace NotifyPropertyChangedRgen
{
	...
	public class TypeCache
	{
		...
		public TypeCache(string typeName, bool caseSensitiveMembers = false) : this(System.Type.GetType(typeName))
		{
	...
	public class TypeResolver
	{
		...
		public static TypeCache ByType(System.Type type)
		{
		...
		public static TypeCache ByName(EnvDTE80.CodeClass2 cc)
		{
