...
namespace NotifyPropertyChangedRgen {
    static class DebugExtensions {
        ...
        public static object DebugMembers(this IEnumerable list, string memberName, string secondMemberName) {
            ...
            var res = from object x in list
                      select new {
                          Member1 = Versioned.CallByName(x, memberName, Microsoft.VisualBasic.CallType.Get),
                          Member2 = Versioned.CallByName(x, secondMemberName, Microsoft.VisualBasic.CallType.Get)
                      };
        ...
        public static void DebugHere() {
            if (System.Diagnostics.Debugger.IsAttached) {
                ...
                var launched = System.Diagnostics.Debugger.Launch();
                if (!launched) {
                    DebugSkipped = true;
                }
