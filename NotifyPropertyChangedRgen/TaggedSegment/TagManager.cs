...
namespace NotifyPropertyChangedRgen {
    public partial class TagManager<T> where T : GeneratorAttribute, new() {
        ...
        public System.Text.RegularExpressions.Regex CommentRegex {
            get {
        ...
        public System.Text.RegularExpressions.Regex RegionRegex {
            get {
                return _RegionRegex;
            }
        }
        ...
        static T GenAttribute {
            get { return _Attribute ?? (_Attribute = new T()); }
        }
